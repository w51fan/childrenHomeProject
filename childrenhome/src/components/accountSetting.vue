  ...
  <div class="accountSettingPage">
    ...
    <div class="content">
      ...
      <van-field
        ...
        input-align="right"
      />
      <van-cell title="身份" :value="User.Type===4?'儿童主任':User.Type===7?'志愿者':User.Type===3?'镇级管理员':User.Type===2?'县级管理员':User.Type===1?'市级管理员':User.Type===6?'助理':User.Type===11?'家长':User.Type===12?'社区工作服务管理员':'村级讲师'" />
      <van-cell title="头像">
        <template #default>
