          ...
          >
            <div class="flex">
              ...
              <div style="text-align: left;padding-left: 10px;">
                ...
                >{{UserTpye===4?'儿童主任':UserTpye===7?'志愿者':UserTpye===3?'镇级管理员':UserTpye===2?'县级管理员':UserTpye===1?'市级管理员':UserTpye===6?'助理':UserTpye===11?'家长':UserTpye===12?'社区工作服务管理员':UserTpye===14?'校儿童主任':UserTpye===15?'校儿童督导员':'村级讲师'}}</div>
              </div>
            </div>
            <div>
